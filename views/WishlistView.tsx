          ...
          >
            ...
            <div className="p-4">
              ...
              <div className="flex justify-between items-center mt-3">
                <span className="text-lg font-bold text-pink-500">Rp{item.price.toLocaleString('id-ID')}</span>
                <button 
                  onClick={(e) => handleAddToCart(e, item)}
                  className="bg-pink-500 text-white px-3 py-1.5 rounded-full text-sm hover:bg-pink-600 transition-colors"
                >
                  Add to Cart
                </button>
              </div>
